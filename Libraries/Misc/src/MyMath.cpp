...
Vector2 Vector2::Modulate(Vector2 const & vector)
{
	return Vector2(x * vector.x, y * vector.y);
}

GLfloat Vector2::Dot(Vector2 const & vector)
{
...
Vector3 Vector3::Modulate(Vector3 const & vector)
{
	return Vector3(x * vector.x, y * vector.y, z * vector.z);
}

GLfloat Vector3::Dot(Vector3 const & vector)
{
...
Vector4 Vector4::Modulate(Vector4 const & vector)
{
	return Vector4(x * vector.x, y * vector.y, z * vector.z, w * vector.w);
}

GLfloat Vector4::Dot(Vector4 const & vector)
{
...
Vector4 Matrix::operator * (Vector4 const & vec)
{
	Vector4 res;
