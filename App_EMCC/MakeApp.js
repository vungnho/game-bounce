...
//setup for compile
var sources = scandir("test").filter(file => file.match(/\.cpp$/));
...
var link = "em++";
var link_flags = "-O3";
var link_options = "-s ALLOW_MEMORY_GROWTH=1 -s ASM_JS=1 --use-preload-plugins --preload-file ../Resources@/Resources ";
